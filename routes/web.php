...
Route::group(['prefix'=>'admin','middleware' => 'checkRoleAdmin'], function(){
	...
	Route::group(['prefix'=>'orders'], function(){
		Route::get('', 'Admin\OrderController@getListOrders')->name('getListOrders');
	});
});
Route::get('','Frontend\HomeController@getIndex');
Route::get('register.html','Frontend\AccountController@getRegister')->name('getRegister');
Route::group(['prefix'=>'ajax'], function(){
		Route::get('district/{province_id}', 'Frontend\AjaxController@getDistrict')->name('getDistrict');
		Route::get('ward/{district_id}', 'Frontend\AjaxController@getWard')->name('getWard');
	});
