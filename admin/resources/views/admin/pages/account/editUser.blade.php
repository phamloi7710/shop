	                ...
	                <div class="col-md-4">
                        <div class="panel-body profile" style="background: url('assets/images/gallery/music-4.jpg') center center no-repeat;">
                            <div class="profile-image">
                                <img class="imagePreview{{$user->id}}" style="width: 100%; height: 100%;" id="previewImageEdit{{$user->id}}" src="{{url('')}}/{{$user->avatar}}" alt="">
                            </div>
                            <input value="{{$user->avatar}}" id="avatar{{$user->id}}" name="avatar" class="form-control" type="hidden">
                        ...
                        <div class="panel-body center">
                            <div class="row">
                                <div class="col-md-6">
                                    <a data-input="avatar{{$user->id}}" data-preview="previewImageEdit{{$user->id}}" class=" btn btn-info btn-xs selectImage" data-toggle="tooltip" data-placement="right" data-original-title="{{__('general.selectImage')}}">{{__('general.selectAvatar')}}</a>
                                </div>
                                <div class="col-md-6">
                                    
                                    <a class="deleteImage{{$user->id}} btn btn-danger btn-xs" href="javascript:;" data-toggle="tooltip" data-placement="right" data-original-title="{{__('general.deleteImage')}}">{{__('general.deleteImage')}}</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            <input name="roles[{{$i}}]" type="checkbox" class="flat" value="{{$value['name']}}" @foreach($userRole as $ccc) @if($ccc->name==$value->name) checked="checked" @endif @endforeach> {{$value['name']}}
                                                        </label>
                                                    </div>
                                                    @php $i++ @endphp
                                                    @endforeach
