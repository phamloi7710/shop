...
<div class="container">
    <div class="row">
        <div id="content" class="col-sm-12">
            ...
            <p>Nếu bạn đã đăng ký tài khoản với chúng tôi, vui lòng <a href="https://bigone.myzozo.net/dang-nhap">đăng nhập</a>.</p>
            <form action="https://bigone.myzozo.net/dang-ky" method="post" enctype="multipart/form-data" class="form-horizontal">
                <fieldset id="account">
                    <legend>Chi tiết tài khoản</legend>
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-firstname">Tên Đầy Đủ</label>
                        <div class="col-sm-10">
                            <input type="text" name="txtName" placeholder="Tên Đầy Đủ" class="form-control">
                        </div>
                    </div>
                    <div class="form-group required">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="tel" name="txtPhone" value="" placeholder="Điện thoại" class="form-control">
                        </div>
                    </div>
                </fieldset>
                <fieldset>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="password" name="confirm" value="" placeholder="Mật khẩu xác nhận" id="input-confirm" class="form-control" />
                        </div>
                    </div>
                </fieldset>
                <fieldset id="address">
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-city">Xã / Phường / Thị Trấn</label>
                        <div class="col-sm-10">
